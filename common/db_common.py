...
class DBCommon(object):
    ...
    ############################
    def get(self, _id):
        return self._request(self._requests.get,self._host+"/"+self._index+"/_doc/"+_id,headers={'Content-Type':'application/json'})

    def get_without_office(self, _id):
        return self._request(self._requests.get,self._host+"/"+self.temp_index+"/_doc/"+_id,headers={'Content-Type':'application/json'})
    ###########################
