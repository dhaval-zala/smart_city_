...
class QueueCounting:
    ...
    def process_frame(self,frame):
        ...
        for botconfig_data in new_data["botconfig_data"]:
            ...
            print("ccheck__site_idsite_idsite_id",site_id)
            # site_name = botconfig_id["site_name"]
            # print("ccheck__site_namesite_namesite_name",site_name)
            # activity_name = botconfig_data["activity_name"]
            # print("ccheck__activity_nameactivity_name",activity_name)
            # node_name = botconfig_data["node_name"]
            # print("ccheck__node_namenode_namenode_name",node_name)
                            ...
                            for zone_ in i["roi"]:
                                try:
                                    ...
                                    for notifications_  in zone_["notification"]:
                                        ...
                                        site_name = sensor_other_data["site_name"]
                                        print("ccheck__site_namesite_namesite_name",site_name)
                                        activity_name = sensor_other_data["activity_name"]
                                        print("ccheck__activity_nameactivity_name",activity_name)
                                        # node_name = botconfig_data["node_name"]
                                        print("ccheck__node_namenode_namenode_name",node_name)
