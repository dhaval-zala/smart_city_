                    ...
                    for i in data['sensors']:
                        ...
                        if i["url"]==json_msg['source']:
                            ...
                            for zone_name in sensor_zone:
                                ...
                                print("notification__count ",queue_count, "notification__id__",notification_id, wait_time_, time__, start_time, diff, zone_name)
                                if real_send == "true":
                                    
                                    if real_snapshot == "true":
                                        if _real_time_flag_json == "true":
                                            self.capture[notification_id][self.camera_id][zone_name]["realtime"] = True
                                            print("notification__send_with_snap_____real_case", queue_count, text_message)
                                            self.send_notification_with_snap(json_msg,time_,date, node_name, self.camera_id, "queuemanage", _time, text_message)
                                        ...
                                        print("notification__send_without_snap___real_case", queue_count, text_message)
                                        self.send_notification_without_snap(json_msg,time_,date, text_message)
                                        self.capture[notification_id][self.camera_id][zone_name]["realtime"] = False
                                    else:
                                        self.capture[notification_id][self.camera_id][zone_name]["realtime"] = False
                                else:
                                ...
                                if normal_send == "true":
                                    if normal_snapshot == "true":
                                        if que_normal_flag == "true":
                                            ...
                                            print("notification__send_with_snap_____normal_case", queue_count, text_message)
                                            self.send_notification_with_snap(json_msg,time_,date, node_name, self.camera_id, "queuemanage", _time, text_message)
                                        else:
                                            self.capture[notification_id][self.camera_id][zone_name]["normal"] = False
                                    elif que_normal_flag == "true":
                                        self.capture[notification_id][self.camera_id][zone_name]["normal"] = False
                                        print("notification__send_without_snap___normal_case", queue_count, text_message)
                                        self.send_notification_without_snap(json_msg,time_,date, text_message)
                                    else:
                                        self.capture[notification_id][self.camera_id][zone_name]["normal"] = False
                                else:
                                ...
                                if pro_send == "true":
                                    if pro_snapshot == "true":
                                        if _pro_activation_flag == "true":
                                            ...
                                            print("notification__send_with_snap_____pro_case", queue_count, text_message)
                                            self.send_notification_with_snap(json_msg,time_,date, node_name, self.camera_id, "queuemanage", _time, text_message)
                                        else:
                                            self.capture[notification_id][self.camera_id][zone_name]["proactive"] = False
                                    elif _pro_activation_flag == "true":
                                        print("notification__send_without_snap___pro_case", queue_count, text_message)
                                        self.send_notification_without_snap(json_msg,time_,date, text_message)
                                        self.capture[notification_id][self.camera_id][zone_name]["proactive"] = False
                                    else:
                                        self.capture[notification_id][self.camera_id][zone_name]["proactive"] = False
