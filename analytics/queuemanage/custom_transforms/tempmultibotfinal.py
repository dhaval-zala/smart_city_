                                    ...
                                    for notifications_  in zone_["notification"]:
                                        ...
                                        try:
                                            for j in range(len(self.queue[botconfig_id][self.camera_id])):
                                                ...
                                                self.entry_count[notification_id][self.camera_id][j][notification_id]=len(self.queue[botconfig_id][self.camera_id][j].entry)
                                                self.exit_count[notification_id][self.camera_id][j][notification_id]=self.entry_count[notification_id][self.camera_id][j][notification_id]-self.total_count[botconfig_id][self.camera_id][j][notification_id]
