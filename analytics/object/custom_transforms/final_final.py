...
class Queue:
    ...
    def real_time_exceed_true(self):
        ...
        #print(self.queue_count,flush=True)
        print("check____1",self.queue_count,self.data["real_time_notification"]["queue_exceeded"]["exceed_length"], flush=True)
...
class QueueCounting:
    ...
    def new_initmethod(self):
        ...
        dbr = DBQuery(host=dbhost, index="notification_responsetypes", office=office)
        inspectionScores = []
        ...
        exceeding_lengths = []
        dbru = DBQuery(host=dbhost, index="notification_rules", office=office)
    ...
    def process_frame(self,frame):
        ...
        text_message = required_data[9][0]
