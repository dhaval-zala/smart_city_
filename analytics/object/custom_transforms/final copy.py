...
class QueueCounting:
    ...
    def initmethod(self):
        ...
        for notifications in data["data"]:
            ...
            for ii in notifications["sensors"]:
                ...
                print("________sdssrdfg______",self.queue[notification_id])
    ...
    def process_frame(self,frame):
        ...
        # def flag_json(exceeding_length, time, queue_count, notification_id_new, sensor_id_new, wait_time):
        ...
        #         flag_json.append(_data)

        #     data = None
        #     try:
        #         with open("/home/custom_transforms/flag_json.json","r") as final_json_temp:
        #             data = json.load(final_json_temp)
        #             print("Data_________________",data)
        #     except:
        #         print("create")
        #         if data == None:
        #             with open("/home/custom_transforms/flag_json.json","w") as final_json_temp:
        #                 json.dump(flag_json, final_json_temp)
        #                 flag = True
        ...
        #             for noti in data:
        #                 if noti["notification_id"] == notification_id_new:
        ...
        #     # if first_flag == "true" and first_flag == "true":
        #     #     with open("/home/custom_transforms/flag_json.json","r") as final_json_temp:
        #     #         json.dump(flag_json, final_json_temp)
        ...
        #     # with open("/home/custom_transforms/flag_json.json","r") as final_json:
        #     #     data = json.load(final_json)
        #     #     print("final_json_data", data)
                            
        #     return [que_normal_flag, real_time_flag, notification_id_new]        
                    ...
                    for i in data['sensors']:
                        ...
                        if i["url"]==json_msg['source']:
                            ...
                            for zone_name in sensor_zone:
                                ...
                                #     # with open("/home/custom_transforms/flag_json.json","r") as final_json:
                                #     #     data = json.load(final_json)
                                #     #     print("wrong in pro final_json_data", data)
                                ...
                                # print("flag_json____1",flag_json(exe, _time, self.total_count[notification_id][self.camera_id][zone_cnt], notification_id, self.camera_id, wait_time))
