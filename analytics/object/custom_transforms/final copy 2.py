...
class QueueCounting:
    ...
    def process_frame(self,frame):
                    ...
                    if first_flag == "true":
                        ...
                        if real_time_flag == "true":
                            ...
                            if (time - data["start_time"])/60 > wait_time:
                                ...
                                return_real_time_flag = "false"
                            print("flag_json____real_time_flag",real_time_flag, time, data["start_time"], (time - data["start_time"])/60)
                            # que_normal_flag = "false"
        ...
        # def pro_active_flag_json(pro_exceeding_length, time, queue_count, required_data, sensor_id_new, wait_time, zone_name):
