...
# }
    ...
    def send_notification_with_snap(self, json_msg,time,date, node_name, sensor_id, botname, timestamp):
        ...
        # "type": "WHATSAPP"
        # }
        temp_path = "http://122.169.112.242:8081/images/"+str(node_name)+"/"+str(sensor_id)+"/"+str(botname)+"/"+"img_"+str(timestamp)+".jpeg"
                    ...
                    for i in data['sensors']:
                        ...
                        if i["url"]==json_msg['source']:
                            ...
                            for zone_name in sensor_zone:
                                ...
                                self.capture[notification_id][self.camera_id][zone_name]["botname"] = "object-detection"
                                ...
                                if real_send == "true":
                                    if real_snapshot == "true":
                                        if _real_time_flag_json == "true":
                                            ...
                                            self.send_notification_with_snap(json_msg,time_,date, node_name, self.camera_id, "object-detection", _time)
